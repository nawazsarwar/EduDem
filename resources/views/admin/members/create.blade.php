    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.members.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('booth_name') ? 'is-invalid' : '' }}" type="text" name="booth_name" id="booth_name" value="{{ old('booth_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('booth_no') ? 'is-invalid' : '' }}" type="text" name="booth_no" id="booth_no" value="{{ old('booth_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('assembly_constituency') ? 'is-invalid' : '' }}" type="text" name="assembly_constituency" id="assembly_constituency" value="{{ old('assembly_constituency', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('home_state') ? 'is-invalid' : '' }}" name="home_state_id" id="home_state_id">
                    @foreach($home_states as $id => $entry)
                        <option value="{{ $id }}" {{ old('home_state_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
